...
import '../chat.screen/new_chat_t.dart';

class WeeklyScheduleScreenT extends StatefulWidget {
  const WeeklyScheduleScreenT({super.key});
...
class _WeeklyScheduleScreenState
    extends State<WeeklyScheduleScreenT> {
